...
<head>
    ...
    <title> Manage Coupons | My3Skills</title>
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="type">Link To</label>
                                            <select class="form-control" name="linked" id="linked" required>
                                        ...
                                        <div class="form-group linked_drop" style="display: none;" id="category_drop">
                                        ...
                                        <div class="form-group linked_drop" style="display: none;" id="course_drop">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="redeem_type">Redeem Type</label>
                                            <select class="form-control" name="redeem_type" id="redeem_type" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="redeem_type">Student Type</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="student" name="student[]" class="form-control select2" multiple="multiple" data-placeholder="Select Students">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php $cnt=1; foreach ($coupon as $a) { ?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        ...
                                        <td><?php echo $cnt++; ?></td>
                                        <td>
                                            Name : <?php echo $a['title']; ?><br>
                                            Code : <?php echo $a['code']; ?><br>
                                            Type : <?php echo $a['type']=="flat"?"Flat Amount":"Percentage"; ?><br>
                                            Limit : <?php echo $a['limit']; ?><br>
                                        </td>
                                        <td><?php echo $a['value']; ?></td>
                                        <td>
                                            Link To : <?php echo $a['link_to']; ?><br>
                                            <?php if($a['link_to']=="category") { ?>
                                                Category : <?php echo $a['category_id']; ?><br>
                                            <?php } ?>
                                            <?php if($a['link_to']=="course") { ?>
                                                Course : <?php echo $a['course_id']; ?><br>
                                            <?php } ?>
                                        </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
       ...
       $('#linked').change(function () {
           ...
           else if(that.val()=='category')
               $('#category_drop').fadeIn();
       });
       ...
       $('#example1').on('click','.modify_data',function () {
          ...
          $.ajax({
              ...
              success : function (response) {
                  ...
                  $('#course').val(info.course_id);
                  $('#category').val(info.category_id);
                  $('#linked').val(info.link_to);
                  $('#code').val(info.code);
                  ...
                  $('#student_type').val(info.student_type);
                  var std=(info.students).split(',');
                  $('#student').val(std);
