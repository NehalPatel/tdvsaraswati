...
<head>
    ...
    <title> Manage Language | My3Skills</title>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Language Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="code">Code</label>
                                            <input type="text" class="form-control" name="code" id="code" placeholder="Language Code">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="default">isDefault</label><br>
                                            <input type="checkbox" name="default" id="default" value="y"> check if default language
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Language</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Language</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($language as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        ...
                                        <td>
                                            <img class="default_change on_button" id="on<?php echo $a['id']; ?>" data-id="<?php echo $a['id']; ?>" data-status="n" src="<?php echo base_url(); ?>/assets/on.png" style="cursor: pointer;display: <?php echo $a['default']=="y"?"block":"none"; ?>">
                                            <img class="default_change off_button" id="off<?php echo $a['id']; ?>" data-id="<?php echo $a['id']; ?>" data-status="y" src="<?php echo base_url(); ?>/assets/off.png" style="cursor: pointer;display: <?php echo $a['default']=="n"?"block":"none"; ?>">
                                        </td>
                                        <td>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/language/';
       ...
       $('#example1').on('click','.modify_data',function () {
        ...
        $('#example1').on('click','.default_change',function(){
            ...
            $.ajax({
                ...
                error : function(response){
                    //show_notification('Ooops...','Something Went Wrong','fa fa-ban','danger');
                }
            });
        });
