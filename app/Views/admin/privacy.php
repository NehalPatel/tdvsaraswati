...
<head>
    ...
    <title> Privacy Policy | My3Skills</title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="device">Privacy Policy</label>
                                            <textarea class="form-control" name="privacy" id="privacy" placeholder="2"><?php echo $config['privacy']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
