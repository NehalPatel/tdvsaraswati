                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Topic 1,Topic 2" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Topic Icon</label>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Topics</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php $cnt=1; foreach ($topic as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        ...
                                        <td><?php echo $cnt++; ?></td>
                                        <td>
                                            Category : <?php echo $a['category']; ?><br>
                                            Subcategory : <?php echo $a['subcategory']; ?><br>
                                        </td>
