...
<head>
    ...
    <title> Contact US | My3Skills</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($contact as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><?php echo $cnt++; ?></td>
                                        <td><?php echo $a['ticket_no']; ?></td>
                                        <td><?php echo $a['name']; ?></td>
                                        <td><?php echo $a['mobile']; ?></td>
                                        <td><?php echo $a['email']; ?></td>
                                        <td><?php echo $a['message']; ?></td>
                                        <td id="status<?php echo $a['id']; ?>">
                                            <a href="javascript:;" class="status_change" data-status="<?php echo $a['status']=="y"?"n":"y"; ?>" data-id="<?php echo $a['id']; ?>"><span class="label label-<?php echo $a['status']=='y'?"success":"danger"; ?>"><?php echo $a['status']=='y'?"<i class='fa fa-check'></i> Closed":"<i class='fa fa-ban'></i>  Open"; ?></span></a>
                                        </td>
                                        <td>
                                            <a title="View Messages" target="_blank" href="<?= base_url()."/dashboard/support_messages/".$a['id']; ?>"><i class="fa fa-envelope"></i></a>
                                            <a title="Delete Message" href="javascript:;" class="remove_data" data-id="<?php echo $a['id']; ?>"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
