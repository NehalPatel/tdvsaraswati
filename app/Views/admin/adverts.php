...
<head>
    ...
    <title> Manage Advertisement | My3Skills</title>
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Advertisement Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="image">Choose Image (1519 * 380)</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="position" id="position" class="form-control">
                                                ...
                                                <option value="slide_right">Side Right</option>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Advertisement</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Advertisement</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($adverts as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><input type="checkbox" class="delete_check" data-id="<?= $a['id']; ?>"></td>
                                        <td><?php echo $cnt++; ?></td>
                                        <td><img src="<?php echo $a['image']; ?>" style="width: 200px;"></td>
                                        <td><?php echo $a['title']; ?></td>
                                        <td><?php echo $a['position']; ?></td>
                                        <td><a href="<?php echo $a['link']; ?>" target="_blank">Click Here</a></td>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/banner/';
