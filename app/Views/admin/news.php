...
<head>
    ...
    <title> Manage News | T D Vashi</title>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add News</button>
...
<script>
    var base_path='<?php echo base_url(); ?>/news/',deleteIds=[];
</script>
<!-- ./wrapper -->
