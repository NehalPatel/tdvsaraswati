...
<head>
    ...
    <title> Manage Teachers | T D Vashi </title>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="designation" id="designation" placeholder="Teacher Designation">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="experience" id="experience" min="1" placeholder="1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="education">Education</label>
                                            <input type="text" class="form-control" name="education" id="education" placeholder="B.A,Bcom">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Teacher</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Teacher</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($teacher as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        ...
                                        <td>
                                            ...
                                            Gender : <?php echo $a['gender']=="male"?"Male":"Female"; ?><br>
                                            Email : <?php echo $a['email']; ?><br>
                                            Mobile : <?php echo $a['mobile']; ?><br>
                                            DOB : <?php echo $a['dob']; ?><br>
                                            Designation : <?php echo $a['designation']; ?><br>
                                            Education : <?php echo $a['education']; ?><br>
                                            Experience : <?php echo $a['experience']; ?><br>
                                            Department : <?php echo $a['department']; ?><br>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/teacher/';
            ...
            if(status=='y'){
                if(confirm('Are you sure to Approve this teacher??')){
                    $.ajax({
                        ...
                        url : base_path + 'status_change_teacher',
                        success : function (response) {
                            if(response=='yes'){
                                if(status=='y')
