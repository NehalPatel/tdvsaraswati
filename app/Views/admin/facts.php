...
<head>
    ...
    <title> Manage Facts | My3Skills</title>
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="url">Enter Heading</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="url">Enter Sub Heading</label>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Facts</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Facts</button>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/facts/';
       ...
       $('#example1').on('click','.modify_data',function () {
          ...
          $.ajax({
              ...
              success : function (response) {
                  ...
                  $('#subheading').val(info.subheading);
                  $('#icon').val(info.icon);
