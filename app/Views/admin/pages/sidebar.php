<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url(); ?>/dashboard" class="brand-link">
        <img src="<?php echo base_url(); ?>/assets/dist/img/AdminLTELogo.png"
             ...
             style="opacity: .8">
        <span class="brand-text font-weight-light">T.D.Vashi</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo base_url()."/".$_SESSION['my3skill']['image']; ?>" class="img-circle elevation-2" alt="User Image" style="height: 34px;width: 34px;border-radius: 50%;">
            </div>
            <div class="info">
                <a href="#" class="d-block"><?php echo $_SESSION['my3skill']['name']; ?></a>
            </div>
        </div>
        <?php
