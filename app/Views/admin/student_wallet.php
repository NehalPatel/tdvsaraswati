            ...
            <div class="row" id="form_div" style="display: none;">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" enctype="multipart/form-data" id="form1" action="<?= base_url().'/dashboard/add_money_student'; ?>">
                            <input type="hidden" name="id" id="hid" value="<?= $student_id; ?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
            ...
            <div class="row" id="remove_div" style="display: none;">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" enctype="multipart/form-data" id="form1" action="<?= base_url().'/dashboard/less_money_student'; ?>">
                            <input type="hidden" name="id" id="hid" value="<?= $student_id; ?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="amount" id="amount" placeholder="Enter Amount" max="<?= $student[0]['balance']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="col-6" style="padding-left: 1%">
                            <br>
                            <b> Student Name : </b> <?= $student[0]['name']; ?><br>
                            <b> Balance : </b> <?= $student[0]['balance']; ?>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
