...
<head>
    ...
    <title> Refund Policy | My3Skills </title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="device">Refund Policy</label>
                                            <textarea class="form-control" name="refund" id="refund" placeholder="2"><?php echo $config['refund']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
