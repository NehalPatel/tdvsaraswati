...
<head>
    ...
    <title> Manage Country | My3Skills</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="currency" id="currency" placeholder="Country Currency" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="code" id="code" placeholder="Currency Code" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="language">Language Code</label>
                                            <input type="text" class="form-control" name="language" id="language" placeholder="Country Language" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="image">Choose Flag</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($country as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><input type="checkbox" class="delete_check" data-id="<?= $a['id']; ?>"></td>
                                        <td><?php echo $cnt++; ?></td>
                                        <td><img src="<?php echo $a['flag']; ?>" style="width: 40px;height: 25px;"></td>
                                        <td>
                                            Name : <?php echo $a['country']; ?><br>
                                            Currency : <?php echo $a['currency']; ?><br>
                                            Code : <?php echo $a['code']; ?><br>
                                            Language : <?php echo $a['language']; ?><br>
                                        </td>
...
<!-- ./wrapper -->
<script>
    var base_path='<?php echo base_url(); ?>/country/';
</script>
