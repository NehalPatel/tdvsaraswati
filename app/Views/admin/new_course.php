                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php $cnt=1; foreach ($course as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        ...
                                        <td id="featured<?php echo $a['id']; ?>">
                                            <a href="javascript:;" class="featured_change" data-status="<?php echo $a['featured']=="y"?"n":"y"; ?>" data-id="<?php echo $a['id']; ?>"><span class="label label-<?php echo $a['featured']=='y'?"success":"danger"; ?>"><?php echo $a['featured']=='y'?"<i class='fa fa-check'></i> Shown":"<i class='fa fa-ban'></i>  Hidden"; ?></span></a>
                                        </td>
