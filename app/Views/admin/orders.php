...
<head>
    ...
    <title> All Orders | My3Skills </title>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" name="student" id="student" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" name="course" id="course" required>
                                                ...
                                                <option value="<?= $s['id']; ?>"><?= $s['course']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Enroll for Course</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Enroll Course </button><br><br>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($orders as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><?php echo $cnt++; ?></td>
                                        <td><?php echo $a['student']; ?></td>
                                        <td><?php echo $a['course']; ?></td>
                                        <td><?php echo date('d-m-Y h:i A',strtotime($a['enroll_date'])); ?></td>
                                        <td><?php echo $a['payment_no']==0?"Admin Enroll":"DEBIT_CARD"; ?></td>
                                        <td><i class="fa fa-inr"></i><?php echo $a['amount']; ?></td>
                                        ...
                                        <td>
                                            <a title="Delete Student" href="javascript:;" class="remove_data" data-id="<?php echo $a['id']; ?>"><i class="fa fa-trash fa-2x"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
       ...
       $('#addBtn').click(function () {
            $('#form1').prop('action',base_path + 'enroll_course');
            $('#data_div').hide();
            $('#form_div').fadeIn();
       });
       ...
       $('#example1').on('click','.remove_data',function () {
          ...
          if(confirm('Are you sure to remove data??')){
              $.ajax({
                  type : 'post',
                  url : base_path + 'delete_payment/' + that.data('id'),
        ...
        $('#example1').on('click','.status_change',function () {
            ...
            $.ajax({
                ...
                url : base_path + 'payments_status_change',
                success : function (response) {
                    if(response=='yes'){
                        if(status=='y')
