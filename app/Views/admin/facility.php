...
<head>
    ...
    <title> Manage Facility | My3Skills </title>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Facility Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="mobile">Short Description</label>
                                            <textarea class="form-control" name="short" id="short" placeholder="Short Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Facility</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Facility</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($facility as $a) {?>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/facility/';
