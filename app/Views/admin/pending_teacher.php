...
<head>
    ...
    <title> Teachers Request | My3Skills </title>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Teacher Request</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <?php $cnt=1; foreach ($teacher as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        ...
                                        <td>
                                            ...
                                            Tagline : <?php echo $a['tagline']; ?><br>
                                            Email : <?php echo $a['email']; ?><br>
                                            Mobile : <?php echo $a['mobile']; ?><br>
                                        </td>
                                        <td>
                                            <?php if($a['resume']!="") { ?>
                                            <a target="_blank" title="Show Resume" href="<?php echo base_url()."/".$a['resume']; ?>">See Resume</a><br>
                                            <?php } ?>
                                            <?php if($a['proof']!="") { ?>
                                            <a target="_blank" title="Show ID Proof" href="<?php echo base_url()."/".$a['proof']; ?>">See ID Proof</a>
                                            <?php } ?>
                                        </td>
                                        <td id="status<?php echo $a['id']; ?>">
                                            <a href="javascript:;" class="status_change" data-status="<?php echo $a['status']=="y"?"n":"y"; ?>" data-id="<?php echo $a['id']; ?>"><span class="label label-<?php echo $a['status']=='y'?"success":"danger"; ?>"><?php echo $a['status']=='y'?"<i class='fa fa-check'></i> Approved":"<i class='fa fa-ban'></i>  Pending Approval"; ?></span></a>
                                        </td>
                                        <td>
                                            <a title="Delete Admin" href="javascript:;" class="remove_data" data-id="<?php echo $a['id']; ?>"><i class="fa fa-trash fa-2x"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
