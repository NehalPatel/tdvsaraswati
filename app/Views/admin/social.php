...
<head>
    ...
    <title> Manage Social | T D Vashi</title>
        ...
        <section class="content">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Social Title</label>
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Social Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Social Link</label>
                                            <input type="text" class="form-control" name="link" id="link" placeholder="fa fa-clock">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Social Class</label>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Social</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Manage Social</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Social</button>
...
<script>
    var base_path='<?php echo base_url(); ?>/social/',deleteIds=[];
</script>
<!-- ./wrapper -->
       ...
       $('#example1').on('click','.modify_data',function () {
          ...
          $.ajax({
              ...
              success : function (response) {
                  ...
                  $('#hid').val(info.id);
                  $('#title').val(info.category);
                  $('#link').val(info.link);
                  $('#class').val(info.class);
