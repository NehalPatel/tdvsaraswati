...
<head>
    ...
    <title> Manage City | My3Skills</title>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="City 1,City 2" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($city as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><input type="checkbox" class="delete_check" data-id="<?= $a['id']; ?>"></td>
                                        <td><?php echo $cnt++; ?></td>
                                        <td>
                                            Country : <?php echo $a['country']; ?><br>
                                            State : <?php echo $a['state']; ?><br>
                                        </td>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/city/',state='';
    $(document).ready(function () {
       ...
       $('#country').change(function () {
            var that=$(this);
            if(that.val().trim()==""){
                errorNotification('Please select an Country');
                return false;
            }
            $.ajax({
                type : 'post',
                url : base_path + 'get_state/'+that.val(),
                success : function (response) {
                    $('#state').html(response);
                    if(state!='')
                        $('#state').val(subcategory);
                },
                error : function () {
