...
<head>
    ...
    <title> Teacher Setting | My3Skills </title>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Payout Setting</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="device">Teacher Revenue</label>
                                            <input type="number" class="form-control" name="teacher" id="teacher" placeholder="80" value="<?php echo $config['teacher_income']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="device">Admin Revenue</label>
                                            <input type="number" class="form-control" name="admin" id="admin" placeholder="20" value="<?php echo $config['admin_income']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
