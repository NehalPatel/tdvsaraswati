...
<head>
    ...
    <title> Manage Event | T D Vashi</title>
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Title 1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="short">Short Description</label>
                                            <textarea class="form-control" id="short" name="short" placeholder="Short Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="long" id="long" placeholder="Long Description"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="short">Event Date</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="short">Choose Image</label>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Event</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($event as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><input type="checkbox" class="delete_check" data-id="<?= $a['id']; ?>"></td>
                                        <td><?php echo $cnt++; ?></td>
                                        <td><img src="<?php echo base_url()."/".$a['image']; ?>" style="height:100px;"></td>
                                        <td><?php echo $a['title']; ?></td>
                                        <td><?php echo $a['short']; ?></td>
                                        <td><?php echo $a['long']; ?></td>
                                        ...
                                        <td>
                                            <a title="Add Images" target="_blank" href="<?= base_url(); ?>/event/images/<?= $a['id']; ?>" class="" data-id="<?php echo $a['id']; ?>"><i class="fa fa-image"></i></a>
