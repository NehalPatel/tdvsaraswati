...
<head>
    ...
    <title> Manage Pages | My3Skills</title>
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="name">Select Widget</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="mobile">Page Slug</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="email">Page Detail</label>
                                            <textarea class="form-control" name="detail" id="detail" placeholder="Detail of the Page" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Page</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Page</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($pages as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><input type="checkbox" class="delete_check" data-id="<?= $a['id']; ?>"></td>
                                        <td><?php echo $cnt++; ?></td>
                                        <td><?php echo ($a['widget']==1)?"Widget 1":($a['widget']==2?"Widget 2" : "Widget 3"); ?></td>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/pages/';
       ...
       $('#example1').on('click','.modify_data',function () {
          ...
          $.ajax({
              ...
              success : function (response) {
                  ...
                  CKEDITOR.instances.detail.setData(info.detail);
