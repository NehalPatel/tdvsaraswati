...
<head>
    <meta charset="utf-8" />
    <title> <?= lang('app.terms_and_condition'); ?> | <?= $config['title']; ?></title>
...
<section id="wishlist-home" class="wishlist-home-main-block">
    <div class="container">
        <h1 class="wishlist-home-heading text-white"><?= lang('app.terms_and_condition'); ?> </h1>
    </div>
</section>
<!-- about-home end -->
<section id="faq-detail-block" class="faq-detail-main-block">
    <div class="container">
        <div class="blog-link btm-30">
            <a href="<?= base_url(); ?>" title="back to home"><i class="fa fa-chevron-left"></i><?= lang('app.back_to_home'); ?></a>
        </div>
        <?= $modify['terms']; ?>
    </div>
</section>
