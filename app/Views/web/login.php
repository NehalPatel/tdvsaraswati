        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="Login-btn txt-rgt">
                    <a href="<?= base_url()."/web/register"; ?>" class="btn btn-outline-primary" title="instructor"><?= lang('app.sign_up'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<!--                    </div>-->
                    <form method="POST" id="mobile_login" class="signup-form" action="<?php echo base_url()."/web/check_login"; ?>">
                        ...
                        <div class="form-group">
                            <button type="submit" id="LoginBtn" class="btn btn-outline-primary" style="width: 100%;height: 55px;">
                                Login
                            </button>
                            <br><br>
                            ------------------------------OR-------------------------------
                            <br><br>
                            <button type="button" id="submitButton"  class="btn btn-outline-info" style="width: 100%;height: 55px;">
                                Request OTP
                            </button>
                            <br>
                            <br>
                            <div class="forgot-password text-center btm-20">
                                <a href="<?= base_url()."/web/forget"; ?>" class="btn btn-outline-info" title="sign-up"><?= lang('app.forget_password'); ?></a>
                            </div>
                        </div>
                        <div class="signin-link text-center btm-20">
                            By signing up, you agree to our <a href="<?= base_url()."/web/terms"; ?>" title="Policy"><?= lang('app.terms_and_condition'); ?> </a>, <a href="<?= base_url()."/web/privacy"; ?>" title="Policy"><?= lang('app.privacy_policy'); ?>.</a>
                        </div>
                        <hr>
                        <div class="sign-up text-center"><?= lang('app.do_not_have_account'); ?>?
                            <a href="<?= base_url()."/web/register"; ?>" title="Create a New Account"> <?= lang('app.sign_up'); ?></a>
                        </div>
                        <hr>
                        <div class="sign-up text-center">Are you a Teacher?<a href="<?= base_url()."/teacher-login"; ?>" title="Teacher Login"> Log In</a>
                        </div>
                    </form>
                </div>
            </div>
