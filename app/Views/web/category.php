...
<section id="wishlist-home" class="wishlist-home-main-block">
    <div class="container">
        <h4 class="wishlist-home-heading text-white"><i class="fa fa-home"></i>&nbsp;/&nbsp;<?= lang('app.categories'); ?> / <?= $modify['category']; ?></h4>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div id="listStyle" class="prod list-view">
                    ...
                    <?php } } else { echo "<center><h3>".lang('app.no_course_found')."</h3></center>"; } ?>
                </div>
