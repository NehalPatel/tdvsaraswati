...
<head>
    ...
    <title> Manage Quiz | My3Skills </title>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="total" id="total" placeholder="30">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">Passing Marks</label>
                                            <input type="number" class="form-control" name="passing" id="passing" placeholder="15">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Quiz</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Quiz</button><br><br>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($quiz as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        <td><?php echo $cnt++; ?></td>
                                        <td><?php echo $a['title']; ?></td>
                                        <td><?php echo $a['course_id']; ?></td>
                                        <td><?php echo $a['total']; ?></td>
                                        <td><?php echo $a['passing']; ?></td>
                                        <td>
                                            <a title="Add Questions" target="_blank" href="<?= base_url()."/teacher-question/".$a['id']; ?>"><i class="fa fa-question"></i> </a>
                                        </td>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/teacher-quiz/';
