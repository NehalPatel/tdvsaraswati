                    ...
                    <div class="card">
                        ...
                        <div class="bootstrap-iso">
                         <div class="container-fluid">
                          <div class="row">
                           <div class="col-12">
                            <form method="post" action="<?php echo base_url(); ?>/announcement-update-data/<?php echo $modify['id']; ?>">
                             <div class="form-group ">
                              ...
                              <select class="select form-control" id="selcourse" name="selcourse" required="">
                               ...
                               <?php foreach($course as $c){ ?>
                                    <option value="<?php echo $c['id']; ?>" <?php if($c['id']==$modify['course_id']){ echo "selected"; } ?> ><?php echo $c['course']; ?></option>
                               <?php } ?>
                              </select>
                             </div> 
                             <div class="form-group ">
                              ...
                              <input type='text' class="form-control" cols="40" id="txttitle" name="txttitle"  required="" value="<?php echo $modify['title'];  ?>"> 
                             </div>
                              <div class="form-group ">
                              <label class="control-label requiredField" for="txtannouncement">
                               Announcement
                               <span class="asteriskField">
                                *
                               </span>
                              </label>
                              <textarea class="form-control" cols="40" id="txtannouncement" name="txtannouncement" rows="10" required=""><?php echo $modify['detail'];  ?></textarea>
                             </div>
                             <div class="form-group">
                              <div>
