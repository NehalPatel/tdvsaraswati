...
<head>
    ...
    <title> Manage Category | My3Skills</title>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Category 1,Category 2">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Category</button><br><br>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($category as $a) {?>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/category/';
