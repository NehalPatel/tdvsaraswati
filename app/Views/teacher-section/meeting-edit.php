                    ...
                    <div class="card">
                        ...
                        <div class="bootstrap-iso">
                         <div class="container-fluid">
                          <div class="row">
                           <div class="col-12">
                            <form method="post" action="<?php echo base_url(); ?>/teacher-meetings-update-data/<?php echo $modify['id']; ?>" id="add-meeting-form">
                             <div class="form-group ">
                              ...
                              <select class="select form-control" id="selcourse" name="selcourse" required="">
                               ...
                               <?php foreach($course as $c){ ?>
                                    <option <?php if($modify['course_id']==$c['id']){ echo "Selected";} ?> value="<?php echo $c['id']; ?>"><?php echo $c['course']; ?></option>
                               <?php } ?>
                              </select>
                             </div> 
                             <div class="form-group ">
                              ...
                              <input type='text' class="form-control"  id="txtmeeting_title" name="txtmeeting_title"  required="" value="<?php echo $modify['meeting_title']; ?>"> 
                             </div>
                             <div class="form-group ">
                              ...
                              <input type='text' class="form-control"  id="txtmeetingid" name="txtmeetingid"  required="" value="<?php echo $modify['meeting_id']; ?>"> 
                             </div>
                              <div class="form-group ">
                              ...
                              <input type="email" class="form-control"  id="txtownerid" name="txtownerid"  required="" value="<?php echo $modify['owner_id']; ?>"> 
                             </div>
                             ...
                             <div class="form-group ">
                              ...
                              <input type="datetime-local" class="form-control"  id="txtmtimedate" name="txtmtimedate"  required="" value="<?php echo $modify['start_time']; ?>"> 
                             </div>
                             <div class="form-group ">
                              ...
                              <input type="datetime" class="form-control"  id="txtzoomurl" name="txtzoomurl"  required=""  value="<?php echo $modify['zoom_url']; ?>"> 
                             </div>
                             <div class="form-group">
                              <div>
