            ...
            <div class="row" id="form_div" style="display: none;">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" enctype="multipart/form-data" id="form1" action="<?php echo    base_url().'/teacher-question-add'; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <a download="" href="<?= base_url()."/assets/sample.csv"; ?>">Download Sample File</a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
