                    ...
                    <div class="card">
                        ...
                        <div class="bootstrap-iso">
                         <div class="container-fluid">
                          <div class="row">
                           <div class="col-12">
                            <form method="post" action="<?php echo base_url(); ?>/announcement-add-data">
                             ...
                             <div class="form-group ">
                              ...
                              <input type='text' class="form-control" cols="40" id="txttitle" name="txttitle"  required=""></textarea>
                             </div>
                              <div class="form-group ">
                              ...
                              <textarea class="form-control" cols="40" id="txtannouncement" name="txtannouncement" rows="10" required=""></textarea>
                             </div>
                             <div class="form-group">
                              <div>
