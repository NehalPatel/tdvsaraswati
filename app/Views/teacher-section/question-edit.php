                    ...
                    <div class="card">
                        ...
                        <div class="bootstrap-iso">
                         <div class="container-fluid">
                          <div class="row">
                           <div class="col-12">
                            <form method="post" action="<?php echo base_url(); ?>/update-teacher-questions/<?php echo $modify['id']; ?>">
                             <div class="form-group ">
                              ...
                              <select class="select form-control" id="selcourse" name="selcourse" required="">
                               ...
                               <?php foreach($course as $c){ ?>
                                    <option <?php if($c['id']==$modify['course_id']){echo "selected";} ?> value="<?php echo $c['id']; ?>"><?php echo $c['course']; ?></option>
                               <?php } ?>
                              </select>
                             </div>
                             <div class="form-group ">
                              ...
                              <select class="select form-control" id="selvideo" name="selvideo" required="">
                               <option value="">
                                ...
                                <?php foreach($video as $v){ ?>
                                    <option <?php if($v['id']==$modify['video_id']){echo "selected";} ?> value="<?php echo $v['id']; ?>"><?php echo $v['title']; ?></option>
                               <?php } ?>
                              </select>
                             </div>
                             <div class="form-group ">
                              ...
                              <textarea class="form-control" cols="40" id="txtquestion" name="txtquestion" rows="10" required=""><?php echo $modify['question']; ?></textarea>
                             </div>
                             <div class="form-group ">
                              ...
                              <select class="select form-control" id="selstatus" name="selstatus" required="">
                               ...
                               <option  <?php if('n'==$modify['status']){echo "selected";} ?> value="n">Deactive</option>
                               <option <?php if('y'==$modify['status']){echo "selected";} ?> value="y">Active</option>
                              </select>
                             </div>
                             <div class="form-group">
                              <div>
