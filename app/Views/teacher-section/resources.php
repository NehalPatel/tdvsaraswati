                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Manage Resources</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Resource Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Resource</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Resource</button><br><br>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($resources as $a) {?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
       ...
       $('#addBtn').click(function () {
            $('#form1').prop('action',base_path + 'teacher-insert-resource');
            $('#data_div').hide();
            $('#form_div').fadeIn();
       });
       ...
       $('#example1').on('click','.remove_data',function () {
          ...
          if(confirm('Are you sure to remove course??')){
              $.ajax({
                  type : 'post',
                  url : base_path + 'teacher-delete-resource/' + that.data('id'),
        ...
        $('#example1').on('click','.modify_data',function () {
            ...
            $.ajax({
                type : 'post',
                url : base_path + 'teacher-modify-resource/' + that.data('id'),
                success : function (response) {
                    //toastr.info(response);
                    var info=JSON.parse(response);
                    $('#hid').val(info.id);
                    $('#title').val(info.title);
                    $('#form1').prop('action',base_path + 'update_resource');
                    $('#data_div').hide();
                    $('#form_div').fadeIn();
                },
                error : function (response) {
