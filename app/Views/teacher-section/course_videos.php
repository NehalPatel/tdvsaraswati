                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php $cnt=1; foreach ($videos as $a) {?>
                                    <tr id="row<?php echo $a['id']; ?>">
                                        ...
                                        <td>
                                            <a target="_blank" title="Different Video Qualities" href="<?= base_url()."/teacher-courses/quality/".$a['id']; ?>"><i class="fa fa-video"></i></a>&nbsp;&nbsp;
                                            <a target="_blank" title="Upload Resources" href="<?= base_url()."/teacher-courses/resources/".$a['id']; ?>"><i class="fa fa-upload"></i></a>
                                            <a target="_blank" title="Upload Subtitles" href="<?= base_url()."/teacher-courses/subtitles/".$a['id']; ?>"><i class="fa fa-language"></i></a>
                                        </td>
                                        <td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
       ...
       $('#addBtn').click(function () {
            $('#form1').prop('action',base_path + 'teacher-insert-video');
            $('#data_div').hide();
            $('#form_div').fadeIn();
       });
       ...
       $('#example1').on('click','.remove_data',function () {
          ...
          if(confirm('Are you sure to remove course??')){
              $.ajax({
                  type : 'post',
                  url : base_path + 'teacher-delete-video-course/' + that.data('id'),
        ...
        $('#example1').on('click','.modify_data',function () {
            ...
            $.ajax({
                type : 'post',
                url : base_path + 'teacher-course-modify-video/' + that.data('id'),
                success : function (response) {
